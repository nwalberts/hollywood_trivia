...
WHERE  movies.year BETWEEN 1980 AND 1989 AND genres.name = 'Science Fiction & Fantasy'
...
WHERE cast_members.character LIKE 'James Bond' AND movies.title NOT LIKE 'Epic Movie'
